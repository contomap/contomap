...
void BinaryEncoder::code(std::string const &name, uint8_t &value)
{
   data.push_back(value);
}

void BinaryEncoder::code(std::string const &name, float &value)
{
...
void BinaryEncoder::code(std::string const &name, std::string &value)
{
   for (char c : value)
   {
...
uintptr_t BinaryEncoder::codeArrayBegin(std::string const &name, size_t &size)
{
...
void BinaryEncoder::codeArrayEnd(uintptr_t)
{
}
